...
class AddExperience extends Component {
  ...
  onSubmit(e) {
    ...
    this.props.addExperience(expData, this.props.history, this.state.handle);
  }
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <TextTopic className="display-4 text-center">
                Add more info
              </TextTopic>
              <p className="lead text-center">
                Add any info ex. your email , contact number :-)
              </p>
