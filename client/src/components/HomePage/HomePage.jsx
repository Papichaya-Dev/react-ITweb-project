										...
										<CustomCol md={4}>
											<CustomCardNew>
												...
												<Card.Body onClick={() => this.readNews()}>
													<Card.Title>
														เปิดเผยข้อมูล Playstation 5 กับ Controller “Dualsense”
													</Card.Title>
													<TextCardNew>
										...
										<CustomColTwo md={4}>
											<CustomCardNew>
												...
												<Card.Body onClick={() => this.readNewsTwo()}>
													...
													<TextCardNew>
														เรียกได้ว่าแทบจะกลายเป็นกิจวัตรประจำสัปดาห์ไปแล้วสำหรับบริษัทอย่าง
														Epic game เจ้าของ engine ชื่อดังอย่าง Unreal engine ที่จะ . . .
													</TextCardNew>
												</Card.Body>
											</CustomCardNew>
										</CustomColTwo>
										...
										<CustomColTwo md={4}>
											<CustomCardNew>
												...
												<Card.Body onClick={() => this.readNewsThree()}>
													<Card.Title>
														Ghost recon breakpoint เตรียมเพิ่มเพื่อนร่วมทาง AI
														ในเดือนกรกฎาคมนี้
													</Card.Title>
													<TextCardNew>
														รอคอยกันมานานกับอัพเดทใหม่ของเกม Ghost Recon Breakpoint
														ที่กำลังจะปล่อย patch ภายในเดือนนี้ พร้อมกับ . . .
													</TextCardNew>
												</Card.Body>
											</CustomCardNew>
										</CustomColTwo>
										...
										<CustomCol md={4}>
											<CustomCardArticle>
												...
												<Card.Body onClick={() => this.readArticle()}>
													<TextCardNewsTitle>
														“หูฟัง” อาวุธสำคัญสำหรับเหล่าเกมเมอร์"
													</TextCardNewsTitle>
													<TextCardNew>
										...
										<CustomColTwo md={4}>
											<CustomCardArticle>
												...
												<Card.Body onClick={() => this.readAeticleTwo()}>
													...
													<TextCardNew>
														สำหรับช่วงของการกักตัว Covid-19
														ทำให้หลายต่อหลายคนไม่สามารถออกจากบ้านได้
										...
										<CustomColTwo md={4}>
											<CustomCardArticle onClick={() => this.readArticleThree()}>
												...
												<Card.Body>
													...
													<TextCardNew>
														สำหรับสื่อบันเทิงต่างๆในปัจจุบัน เราไม่อาจปฏิเสธิได้เลยว่า
														‘เสียง’ คือหนึ่งในสื่อที่มีอิทธิพลอย่างมาก ไม่ว่าจะเป็น . . .
													</TextCardNew>
												</Card.Body>
											</CustomCardArticle>
										</CustomColTwo>
									...
									<CustomRow>
										<CustomCol md={4}>
											<CustomCardArticle>
												...
												<Card.Body onClick={() => this.readReview()}>
													<Card.Title>
														Hatred – ศาลเตี้ยล้างบางผู้คน กับเนื้อหาสุดดาร์ค
													</Card.Title>
													<TextCardReview>
														วันนี้เรามาพบกับรีวิวเกมที่เป็นหนึ่งในเกมที่ถูกแบนจากหลายๆประเทศ
														ด้วยความรุนแรงและเนื้อหาที่มืดมน
														ของชายผู้บ้าคลั่งออกไล่ฆ่าผู้คนด้วยเหตุผลที่เข้าใจได้อย่าง
														Hatred . . .
													</TextCardReview>
												</Card.Body>
											</CustomCardArticle>
										...
										<CustomColTwo md={4}>
											<CustomCardArticle>
												...
												<Card.Body onClick={() => this.readReviewTwo()}>
													...
													<TextCardReview>
														สำหรับรีวิวในครั้งนี้ คือเกม FPS จากปี 2013 ที่ผสมผสานความเป็น
														Action กับ RPG ไว้อย่างลงตัว
														และเนื้อเรื่องที่ซับซ้อนน่าติดตามกับ Bioshock Infinite . . .
													</TextCardReview>
												</Card.Body>
											</CustomCardArticle>
										</CustomColTwo>
										...
										<CustomColTwo md={4}>
											<CustomCardArticle onClick={() => this.readReviewThree()}>
												...
												<Card.Body>
													<Card.Title>
														HyperX cloud earbuds – Earbuds ใส่สบายจากค่าย HyperX
													</Card.Title>
													<TextCardReview>
